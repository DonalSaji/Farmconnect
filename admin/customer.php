					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						...
						<tbody>
							...
							foreach ($result as $row) {
								$i++;
								?>
								<tr class="<?php if($row['user_type']=='co-admin') {echo 'bg-g';}else {echo 'bg-r';} ?>">
									<td><?php echo $i; ?></td>
									<td><?php echo $row['name']; ?></td>
									<td><?php echo $row['email']; ?></td>
									<td>
										Address : <?php echo $row['address']; ?><br>
										Pin : <?php echo $row['pin']; ?><br>
									</td>
									<td><?php if($row['user_type']=='co-admin') {echo 'Co-Admin';} else {echo 'User';} ?></td>
									<td>
