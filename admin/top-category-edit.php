...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['cat_name'])) {
		...
		$statement = $pdo->prepare("SELECT * FROM category WHERE cat_name=? and cat_name!=?");
    	$statement->execute(array($_POST['cat_name'],$current_cat_name));
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE category SET cat_name=? WHERE cat_id=?");
