                    ...
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu">
                          <ul>
                              ...
                              <li class="current-list-item"><a href="blog.html">Blog</a>
                                 <!-- <ul class="sub-menu">
                              ...
                              <li><a href="shop1/index.php">Shop</a>
                                  <ul class="sub-menu">
                                      <li><a href="shop1/index.php">Shop</a></li>
                                      <li><a href="shop1/checkout.html">Check Out</a></li>
                                      <li><a href="shop1/cart.php">Cart</a></li>
                                  </ul>
                              </li>
                              <li>                                   
