...
.stickyI {
  ...
  <body class="main-layout">
                    ...
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu">
                            <ul>
                                ...
                                <li>                                   
                                      <a class="shopping-cart" href="admin/profile.php"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a>
                                      <ul class="sub-menu">
      ...
      <div class="slider_main">
        ...
        >
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item">
              <picture>
                <source srcset="images/3.jpg" />
                <source srcset="images/farm6.jpg" />
                <source srcset="images/farm3.jpg" />
                <source srcset="images/farm1.jpg" />
                <img
                  srcset="images/3.jpg"
                  alt="responsive image"
                  class="d-block img-fluid"
        ...
        <div class="row d_flex">
          <div class="col-lg-6 col-md-12">
            <div class="titlepage text_align_left">
              ...
              <h2>Farmconnect</h2>
              <p>
                Welcome to FarmConnect the Home of Farmers.FarmConnect brings
                together the agricultural community.we have been trusted source of
                information to farmers.Today we continue this legacy of quality
                informatio,while also serving as connection hub for people,ideas
                and inspiration for the entire agriculture industry
              </p>
    ...
    <!-- end news -->
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.537458475236!2d74.84373401448302!3d12.873124120515355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba35a499fbec1b5%3A0xe5c391506b7a1a96!2sSt%20Aloysius%20College%20(Autonomous)!5e0!3m2!1sen!2sin!4v1651755587404!5m2!1sen!2sin"
          width="600"
          height="430"
          frameborder="0"
