...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section">
    	...
    	<div class="recentlyadded1 content-wrapper1">
    <h2>Recently Added Products</h2>
        <?php foreach ($recently_added_products as $product): ?>
        <a href="index.php?page=product&id=<?=$product['id']?>" class="product1">
            <img src="images/<?=$product['img']?>" width="200" height="200" alt="<?=$product['product']?>">
            <span class="name1"><?=$product['product']?></span>
            <span class="price1">
                &#8377;<?=$product['price']?>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <p>Far far away, behind the word mountains, far from the state Kerala and Karnataka, there live the blind texts. Separated they live in</p>
          </div>
        </div>
            ...
            <div class="carousel-testimony owl-carousel">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(images/person_1.png)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text text-center">
                    <p class="mb-5 pl-4 line">Far far away, behind the word mountains, far from the state Kerala and Karnataka, there live the blind texts.</p>
                    <p class="name">Shibin SK</p>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/partner-1.png" class="img-fluid" alt="Dream Epic Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/partner-2.png" class="img-fluid" alt="Dream Epic Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/partner-3.png" class="img-fluid" alt="Dream Epic Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/partner-4.png" class="img-fluid" alt="Dream Epic Template"></a>
    			</div>
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="images/partner-5.png" class="img-fluid" alt="Dream Epic Template"></a>
    			</div>
    		</div>
    	</div>
    </section>
