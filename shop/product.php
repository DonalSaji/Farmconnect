...
<div class="loader_bg">
    ...
    <div class="container">
        <a class="navbar-brand" href="../index.php"><img src="../images/logo1.png " width="70px" height="50px"></a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="https://www.india.gov.in/topics/agriculture">Government policies</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        ...
                        if (isset($_SESSION['user_name']) && isset($_SESSION['user_id'])) {
                            echo '<a class="dropdown-item">Name: <span>' . $_SESSION['user_name'] . '</span></a>';
                            echo '<a class="dropdown-item">ID:FC<span>' . $_SESSION['user_id'] . '</span></a>';
                ...
                <li class="nav-item cta cta-colored"><a href="cart.php" class="nav-link"><span class="icon-shopping_cart"></span><?php echo isset($_SESSION['cart']) ? count($_SESSION['cart']) : 0; ?></a></li>
                &nbsp;
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <p class="price">
                    <p class='price'><span class='price-sale'> &#8377; <?php echo $row["rrp"]?> </p>
                </p>
