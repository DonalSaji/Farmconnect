	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="../contact1.php" class="nav-link">Contact</a></li>                                 
				...
				<div class="dropdown-menu" aria-labelledby="dropdown04">
					<a class="dropdown-item"  >Name: <span></span></a>
					<a class="dropdown-item" >ID:FC<span></span></a>
			  ...
			  &nbsp;
			  <li class="nav-item cta cta-colored"><a href="login_form.php" class="nav-link"><span>Login</span></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
