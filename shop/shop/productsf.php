...
$stmt = $pdo->prepare('SELECT * FROM products where category="fruit"');
...
$total_products = $pdo->query('SELECT * FROM products where category="fruit"')->rowCount();
?>
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li class="active" data-filter="fruit"><a href="index.php?page=productsf">FRUIT</a></li>
