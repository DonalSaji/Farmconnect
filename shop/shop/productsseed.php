...
$stmt = $pdo->prepare('SELECT * FROM products where category="seed"');
...
$total_products = $pdo->query('SELECT * FROM products where category="seed"')->rowCount();
?>
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li class="active" data-filter="seed"><a href="index.php?page=productsseed">SEED</a></li>
