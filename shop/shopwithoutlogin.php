  ...
  <div class="loader_bg">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <div class="dropdown-menu">
	          ...
	          <li  class="nav-item active dropdown"><a href="#" class="nav-link">Shop</a></li>
				<li class="nav-item"> <a class="nav-link" href="../login_form.php"> Login</a>
				</div>
		  </li>
    ...
    <div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(images/category.jpg);">
        <div class="text text-center">
            ...
            <p><a href="login.php" class="btn btn-primary" onclick="return redirectToLogin()">Shop now</a></p>
        </div>
    </div>
</div>
							<div class="col-md-6">
        ...
        <div class="row">
            <?php foreach ($recently_added_products as $product): ?>
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="productwithoutlogin.php?id=<?=$product['product_id']?>" class="img-prod">
...
function redirectToLogin() {
    alert("You need to login in order to shop");
