...
$stmt = $pdo->prepare('SELECT * FROM products where category="vegetable"');
...
$total_products = $pdo->query('SELECT * FROM products where category="vegetable"')->rowCount();
?>
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li class="active" data-filter="vegitable">VEGITABLE</li>
